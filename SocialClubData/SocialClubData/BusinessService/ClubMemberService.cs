...
namespace SocialClubData.BusinessService
{
    using System.Data;
    using System.IO;
    using SocialClubData.DataAccess;
    ...
    public class ClubMemberService : IClubMemberService
    {
        ...
        {
            var sw = new StreamWriter("OTLOG.log", true);
            sw.WriteLine(data);
            sw.Close();
        ...
        {
            this.memberAccess = new ClubMemberAccess(logData);
        }
